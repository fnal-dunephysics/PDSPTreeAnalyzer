#include "./Analyzers/PionSkimTreeMaker.h"
...
void run_skimmer(){
  ...
  //m.AddFile("/Users/sungbino/OneDrive/OneDrive/ProtoDUNE-SP/PionKI/root/PDSPProd4_data_0.5GeV_reco2_ntuple_v09_41_00_04.root"); // 0.5 GeV data local makbook
  ...
  //m.SetOutfilePath("hists_Data_1.0GeV_PionSkimTreeMaker.root");
  m.SetOutfilePath("hists_MC_1.0GeV_PionSkimTreeMaker.root");
  m.Init();
