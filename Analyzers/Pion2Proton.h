#ifndef Pion2Proton_h
#define Pion2Proton_h

#include "AnalyzerCore.h"

class Pion2Proton : public AnalyzerCore {
 ...
 public:
  ...
  void Study_leading_proton(Daughter leading_p, double weight);
  void FillLeadingProtonPlot(TString suffix, Daughter leading_p, double weight);
